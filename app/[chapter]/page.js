...
export default function Chapter() {
  ...
  const handleClick = (index) => {
    ...
    if (chapter !== "alphabets"){
      ...
      console.log(subProgress[(index - 1).toString()])
  ...
  return (
    <main className="px-4 py-4 mb-14 sm:px-16 md:px-20 bg-[var(--bg-theme)]" style={{minHeight: 'calc(100vh - 50px)'}}>
      ...
      <h1 className="text-xl font-bold text-center my-4 text-[var(--text-theme)]">
        {(chapter.charAt(0).toUpperCase() + chapter.slice(1).toLowerCase()).replace(/-/g, ' ')}
      </h1>
