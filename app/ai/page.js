...
export default function AIPage() {
  ...
  return (
    <main className="relative bg-[#1a1a1a] text-[#1a1a1a] text-white p-4" style={{height: 'calc(100vh - 52px)'}}>
      {/* Hero */}
      {messages.length == 0 ? <>
        <motion.div
        ...
        <form
          onSubmit={handleSubmit}
          className="fixed bottom-26 flex items-center gap-2 p-3 mt-4 bg-[#2a2a2a] rounded-xl shadow-md"
